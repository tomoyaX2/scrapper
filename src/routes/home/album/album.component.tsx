...
import { getGalleries, removeFromGallery } from 'src/store/galleries';
...
const Album = ({
  ...
  const onRemoveFromGallery = (galleryId: string, albumId: string) => {
    dispatch(removeFromGallery({ galleryId, albumId }));
      ...
      <div className='bg-primary w-80 mt-12 mx-4 h-7 p-1 '>
        {galleryId && (
          <Button
            ...
            onClick={() => onRemoveFromGallery(galleryId, id)}
          >
