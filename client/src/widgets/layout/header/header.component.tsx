...
const Header = (): JSX.Element => (
  <header className='bg-black-300 flex items-center justify-between px-10 py-4'>
    ...
    <div className='flex flex-row items-center'>
      ...
      <div className='md:flex flex-row items-center sm:hidden xsm:hidden'>
        <Button className='bg-black-300 text-white hover:bg-black-100 px-4 py-2 rounded-md w-28'>
          Sign In
        </Button>
      ...
      <div className='h-screen w-screen fixed md:hidden sm:flex xsm:flex flex-col bg-black-400 opacity-40 top-0 right-0' />
      <div className='h-screen absolute md:hidden sm:flex xsm:flex flex-col w-64 bg-black-400 top-0 right-0'>
